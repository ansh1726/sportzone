...
const Products = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex">
      {/* Sidebar */}
      <div className="w-56 flex-shrink-0 bg-white border-r border-gray-200 p-5 sticky top-16 h-[calc(100vh-64px)] overflow-y-auto">
        ...
        <div>
          ...
          <div className="flex items-center gap-2 px-2 py-1.5 rounded-lg text-sm text-gray-600 cursor-pointer hover:bg-gray-50">
