...
const ManageUsers = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-950 p-6">
      <div className="mb-6">
        <h1 className="text-lg font-semibold text-gray-100">Manage Users</h1>
      ...
      <input
        ...
        className="w-full bg-gray-900 border border-gray-800 text-gray-300 text-sm placeholder-gray-600 rounded-lg px-3 py-2 mb-5 focus:outline-none focus:border-orange-500"
      />
              ...
              return (
                ...
                >
                  ...
                  <span className={`text-xs px-2 py-1 rounded-full w-fit ${
                    u.role === "admin" ? "bg-orange-500/20 text-orange-400" : "bg-gray-800 text-gray-400"
                  }`}>
